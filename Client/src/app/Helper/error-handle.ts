import { BadInput } from './execptions/bad-input';
import { ToastrService } from 'ngx-toastr';
import { ErrorHandler, Inject, Injector, Injectable } from '@angular/core';
import { NotFoundError } from './execptions/not-found-error';
import { UnauthorizedError } from './execptions/unauthroized-error';
